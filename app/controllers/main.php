...
class main {
	...
	function index($idx=false, $num=false, $sec=false, $sub=false){
		...
		if(!$num) {
			...
			shuffle($cont['sect']);
			Load::view('main.html', $cont);
		} else {
			switch ($sec){
				case "portada":		$cont = $this->cont['covr']; break;
				case "cultura":		$cont = $this->cont['cult']; break;
				case "ecologia":	$cont = $this->cont['ecol']; break;
				case "viajes":		$cont = $this->cont['viaj']; break;
				case "restaurantes":$cont = $this->cont['rest']; break;
				case "lugares":		$cont = $this->cont['luga']; break;
				case "eventos":		$cont = $this->cont['even']; break;
				case "sociales":	$cont = $this->cont['soci']; break;
			}
			Load::view('section.html', $cont);			
		}
	}
