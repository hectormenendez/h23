...
$_CFG = array(
	...
	// cachedir	=	The path (must have write permission) where cache files should be stored (default:system cache).
	...
	//  sess_matchip = Make the session ID match the IP of the user.
	//  sess_matchua = Make the session ID match the User Agent.
