...
class Session {
	...
	**/
	public static function _construct(){
		...
		//if (!is_bool(self::$_MIP=Core::config('sess_matchip'))) self::_error('VARFOR','sess_matchip');
		//if (!is_bool(self::$_MUA=Core::config('sess_matchua'))) self::_error('VARFOR','sess_matchua');
		...
		// run this at the end of scripts so the session writes every time.
	...
	public static function start(){
		...
		// I have pending the username handling in case of authenticated sessions. 
